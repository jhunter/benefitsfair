...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
     ...
     //    wp_enqueue_script('modernizr'); // Enqueue it!
        ...
        wp_register_script('alpine','https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js', array(), '1.0.0'); // Custom scripts
        wp_enqueue_script('alpine'); // Enqueue it!

        wp_register_script('alpineIE11','https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine-ie11.min.js', array(), '1.0.0'); // Custom scripts
        wp_enqueue_script('alpineIE11'); // Enqueue it!
    }
}
...
function html5blank_conditional_scripts()
{
    ...
    //     wp_register_script('alpine', 'https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js', array(), '1.0.0'); 
...
function html5blank_styles()
{
    ...
    wp_register_style('mainstyle', get_template_directory_uri() . '/assets/dist/benefitsfair.css', array(), '1.0', 'all');
    wp_enqueue_style('mainstyle'); // Enqueue it!
    wp_register_style('custom', get_template_directory_uri() . '/assets/dist/custom.css', array(), '1.0', 'all');
