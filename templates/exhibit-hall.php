  ...
  <div class="bg-teal-900 pb-32">
    ...
    <header class="py-10">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="mt-3 max-w-xl text-lg leading-6 text-teal-300">
    ...
    <div class="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8 space-y-8">
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/1438256546.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
            ...
            <li class="col-span-1">
              <a href="/booth.html" class="group block w-full flex items-center justify-between px-6 py-4 space-x-4 bg-white border border-gray-300 rounded-md hover:bg-blue-50 hover:border-blue-500 focus:outline-none focus:bg-blue-50 focus:border-blue-500 transition duration-150 ease-in-out">
                ...
                <div class="flex-1">
                  ...
                  <p class="mt-1 text-gray-500 text-sm leading-5">Cigna Dental</p>
                </div>
                <div>
                  <svg class="h-5 w-5 text-gray-400 group-hover:text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
      ...
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/793872274.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
          <h3 class="relative md:w-64 md:ml-auto text-4xl leading-9 font-black md:text-right text-white text-shadow">
      ...
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/751465522.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
          <h3 class="relative md:w-64 md:ml-auto text-4xl leading-9 font-black md:text-right text-white text-shadow">
      ...
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/1091044655.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
          <h3 class="relative md:w-64 md:ml-auto text-4xl leading-9 font-black md:text-right text-white text-shadow">
            Well-Being
          </h3>
        </div>
      ...
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/669130018.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
          <h3 class="relative md:w-64 md:ml-auto text-4xl leading-9 font-black md:text-right text-white text-shadow">
      ...
      <div class="bg-gray-100 shadow overflow-hidden rounded-lg md:flex">
        <div class="md:w-1/3 relative px-4 py-5 border-b md:border-none border-gray-200 bg-gray-900 sm:px-6 flex items-end overflow-hidden">
          <img alt="..." src="<?= get_template_directory_uri() ?>/img/1090948673.jpg" class="hidden md:block absolute object-cover inset-0 w-full h-full">
          <h3 class="relative md:w-64 md:ml-auto text-4xl leading-9 font-black md:text-right text-white text-shadow">
            Parkland Benefits
          </h3>
        </div>
