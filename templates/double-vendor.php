<?php
/*
Template Name: Double Vendor Booth
  ...
  <div class="bg-pkl-800 relative">
    ...
    <div class="relative bg-gray-800 overflow-hidden">
          ...
          <main class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:pl-8 lg:pr-12 py-10 sm:py-12 md:py-16 lg:pt-16 lg:pb-48">
            <div class="justify-center">
              <div class="flex relative overflow-hidden flex-shrink-0 -space-x-10">
                <img class="w-32 h-32 rounded-full flex-shrink-0 border-gray-800 border-4 object-cover" src="https://logo.clearbit.com/travelers.com" alt="">
                <img class="w-32 h-32 rounded-full flex-shrink-0 border-gray-800 border-4 object-cover" src="<?= get_template_directory_uri() ?>/img/libertymutual.jpg" alt="">
              </div>
              <div class="flex-1 mt-2 ">
                ...
                <div class="inline-grid grid-cols-1 md:grid-cols-2 mt-4 row-gap-2 md:col-gap-4">
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-3/5">
        <img class="h-56 w-full object-cover object-top sm:h-72 md:h-96 lg:w-full lg:h-full" src="<?= get_template_directory_uri() ?>/img/lg-669130018.jpg" alt="">
      </div>
    </div>
  </div>
