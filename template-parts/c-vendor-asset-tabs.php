            ...
            <div class="border-b border-gray-200">
              <nav class="flex -mb-px space-x-1 px-6">
                ...
                <button :class="openTab === 'Events' ? activeClasses : inactiveClasses" @click="openTab = 'Events'" class="group inline-flex items-center py-5 px-5 border-b-2 font-medium text-sm leading-5 focus:outline-none" aria-current="page">
                  <svg :class="openTab === 'Events' ? activeIcon : inactiveIcon"class="-ml-0.5 mr-2 h-6 w-6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>calendar-favorite</title><path d="M21.5,3H18.75a.25.25,0,0,1-.25-.25V1a1,1,0,0,0-2,0v4.75a.75.75,0,1,1-1.5,0V3.5a.5.5,0,0,0-.5-.5H8.25A.25.25,0,0,1,8,2.751V1A1,1,0,1,0,6,1v4.75a.75.75,0,1,1-1.5,0V3.5A.5.5,0,0,0,4,3H2.5a2,2,0,0,0-2,2V22a2,2,0,0,0,2,2h19a2,2,0,0,0,2-2V5A2,2,0,0,0,21.5,3Zm0,18.5a.5.5,0,0,1-.5.5H3a.5.5,0,0,1-.5-.5V9.5A.5.5,0,0,1,3,9H21a.5.5,0,0,1,.5.5Z"></path><path d="M16.028,13.578h-2.05L12.9,11.065l-.01-.021a.995.995,0,0,0-1.782.021l-1.085,2.513H7.967a.945.945,0,0,0-.9.585.977.977,0,0,0,.245,1.074l1.791,1.6-1,2.293a.966.966,0,0,0,.242,1.116.991.991,0,0,0,.665.259,1,1,0,0,0,.493-.131L12,18.968l2.488,1.4a.982.982,0,0,0,1.158-.128.965.965,0,0,0,.242-1.116l-1-2.293L16.7,15.224a.972.972,0,0,0,.231-1.06A.949.949,0,0,0,16.028,13.578Z"></path></svg>
                  <span>Events</span>
                </button>
                <?php endif; ?>
                <?php if($handouts) : ?>
