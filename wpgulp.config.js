...
module.exports = {
	...
	// Style options.
	styleSRC: './assets/src/scss/benefitsfair.scss', // Path to main .scss file.
	styleDestination: './assets/dist/', // Path to place the compiled CSS file. Default set to root folder.
	...
	// Watch files paths.
	watchStyles: './assets/src/**/*.scss', // Path to all *.scss files inside css folder and inside them.
