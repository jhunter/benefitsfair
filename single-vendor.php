  ...
  <div class="bg-pkl-800 relative">
    ...
    <div class="relative bg-gray-800 overflow-hidden">
            ...
            <div class="justify-center">
              ...
              <div class="flex-1 mt-2 ">
                ...
                <div x-show="!double" class="inline-grid grid-cols-1 md:grid-cols-2 mt-4 gap-y-2 md:gap-x-4">
                  ...
                  <a class="flex nounderline hover:underline text-white hover:text-cool-gray-100 transition duration-150 ease-in-out" href="tel:+18009952608">
      ...
      <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-3/5">
        <div x-show="!double" class="h-56 w-full bg-cover bg-center bg-top sm:h-72 md:h-96 lg:w-full lg:h-full" style="background-image:url(<?= get_template_directory_uri() ?>/img/1683310141.jpg)"></div>
