          ...
          <div class="-mb-px flex items-center justify-between h-16 px-4 sm:px-0">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <a href="<?= site_url()?>/exhibit-hall" class="px-3 py-5 text-sm font-medium text-gray-300 hover:text-white border-b-2 border-transparent hover:border-white focus:border-white focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Exhibit Hall</a>
    ...
    <div class="relative bg-gray-800 overflow-hidden">
        <div class="max-w-screen-xl mx-auto">
          <div class="relative z-10 bg-gray-800 lg:max-w-xl lg:w-full">
            ...
            <main class="pt-10 mx-auto max-w-screen-xl px-4 sm:py-12 sm:px-6 md:py-16 lg:py-20 lg:px-8 xl:py-28 xl:pb-48">
                <div class="md:flex md:space-x-4 justify-center">
                    <img class="w-32 h-32 bg-blue-300 rounded-full flex-shrink-0 border border-gray-300 object-cover" src="<?= get_template_directory_uri() ?>/img/milliman.png" alt="">
                    <div class="flex-1">
                      <h1 class="text-4xl leading-9 font-bold text-white md:mt-0">
                        Milliman
                      </h1>
                      ...
                      <dl class="mt-4 space-y-2 md:flex md:space-y-0 md:space-x-4">
                        <dd class="flex items-center text-sm leading-5 font-medium">
                      ...
                      <button @click="openModal = true" class="mt-6 group block w-full md:w-auto flex items-center text-left p-6 space-x-4 bg-white border border-gray-300 rounded-md hover:bg-blue-50 hover:border-blue-500 focus:outline-none focus:bg-blue-50 focus:border-blue-500 transition duration-150 ease-in-out">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-3/5">
          <img class="h-56 w-full object-cover object-top sm:h-72 md:h-96 lg:w-full lg:h-full" src="<?= get_template_directory_uri() ?>/img/669130018.jpg" alt="">
        </div>
      </div>
  </div>

  <main class="-mt-32 relative z-20">
    <div class="max-w-7xl mx-auto pb-12 px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      class="bg-gray-100 shadow overflow-hidden rounded-lg">
        ...
        <div id="panels" class="px-4 py-5 sm:px-6">
          <div id="tab-events" class="space-y-8">
          ...
          <div id="tab-handouts"></div>
          <div id="tab-videos"></div>
        </div>
      </div>
    </div>
  </main>
  ...
  <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-md sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline" @click.away="openModal = false">
    <div class="p-4 sm:p-6 ">
      <div class="text-center">
        ...
        <form action="#" method="POST" class="grid grid-cols-1 row-gap-6 mt-4">
    ...
    <div class="p-4 sm:p-6 bg-gray-50 border-t-2 border-gray-200">
      <p class="text-xs leading-5 text-gray-500">Please do not include personal details in your message, such as Social Security number. This email is only active during Live Virtual Benefit Fair days. This email is only active during Live Virtual Benefit Fair days.</p>
    </div>
  </div>
</div>
<!-- banner -->
